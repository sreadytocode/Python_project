...
type2 = Type("Shalwar Kameez")
type_repository.save(type2)

type3 = Type("Sharara")
type_repository.save(type3)

garment1 = Garment("Mint and gold dress", brand1, type1, "Celestial mint and gold dress with embroidered chiffon and silk.", 15, 100.00, 165.00)
garment_repository.save(garment1)

garment2 = Garment("Coral pink shalwar kameez", brand2, type2, "A classic silhouette with embellishments provides a beautiful coral-pink look.", 16, 95.00, 150.00)
garment_repository.save(garment2)

garment3 = Garment("Black and gold dress", brand1, type1, "A dreamy noir dress with delicate embroidery details on chiffon. A mix of thread combined with golden zari and sequins weaves a magic to create this flawless heavenly design.", 16, 90.00, 120.00)
garment_repository.save(garment3)

garment4 = Garment("Organza yellow sharara", brand2, type3, "A stunningly accentuated shirt with beautiful florals. With an off white sharara trousers", 25, 110.00, 200.00)
